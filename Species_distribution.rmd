...
habitat_preferences$species_1001 <- ifelse(habitat_preferences$G.3.6. > 0 || habitat_preferences$G.4.3. > 0, 1, 0)
habitat_preferences$species_1090 <- ifelse(habitat_preferences$G.3.6. > 0 || habitat_preferences$G.3.5. > 0, 1, 0)
habitat_preferences$species_1008 <- ifelse(habitat_preferences$G.3.6. > 0 || habitat_preferences$G.4.3. > 0 || habitat_preferences$G.3.2. > 0 || habitat_preferences$G.4.2. > 0, 1, 0)
habitat_preferences$species_1027 <- ifelse(habitat_preferences$G.3.6. > 0, 1, 0)
habitat_preferences$species_8330 <- ifelse(habitat_preferences$G.3.6. > 0 || habitat_preferences$G.4.3. > 0, 1, 0)
habitat_preferences$species_1170 <- ifelse(habitat_preferences$G.3.6. > 0 || habitat_preferences$G.3.5. > 0, 1, 0)

habitat_preferences$species_1001 <- habitat_preferences$G.3.6.+ habitat_preferences$G.4.3.
habitat_preferences$species_1090 <- habitat_preferences$G.3.6.+ habitat_preferences$G.3.5.*0.5 
habitat_preferences$species_1008 <- habitat_preferences$G.3.6. + habitat_preferences$G.4.3. + habitat_preferences$G.3.2. + habitat_preferences$G.4.2. *0.5
habitat_preferences$species_1027 <- habitat_preferences$G.3.6.
habitat_preferences$species_8330 <- habitat_preferences$G.3.6. + habitat_preferences$G.4.3. 
habitat_preferences$species_1170 <- habitat_preferences$G.3.6. + habitat_preferences$G.3.5.

habitat_preferences <- habitat_preferences %>%
  mutate(species_1001 = G.3.6. + G.4.3.,
         species_1090 = G.3.6. + 0.5 * G.3.5.,
         species_1008 = G.3.6. + G.4.3. + G.3.2. + 0.5 * G.4.2.,
         species_1027 = G.3.6.,
         species_8330 = G.3.6. + G.4.3.,
         species_1170 = G.3.6. + G.3.5.)
...
for (i in species_habitat_codes){
  ...
  model_2 <- glm(formula = pojava~bati_mean*morska_med+y+bati_media+morska_mea, train_df, family = "binomial")
