...
wfs_10x10_url <- "pagingEnabled='true' preferCoordinatesForWfsT11='false' restrictToRequestBBOX='1' srsname='EPSG:3765' typename='dzzpnpis:hr10x10' url='http://services.bioportal.hr/wms"
...
for (i in species_habitat_codes){
  ...
  predictors %>% filter(pred_norm > 0.49) %>% 
