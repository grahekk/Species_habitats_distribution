...
last but not lest, x and y coordinate variables are added, bacause y variable is later used as one of the predictors. Also, latitude preferences are added
...
for (i in species_habitat_codes){
  ...
  if (species_habitat_code == "1027" | species_habitat_code=="1001"){
   ...
   else ({formula <- paste0("pojava ~ bati_norm+y_norm+
                    area_pct_species_", species_habitat_code, ":habitat_preferences_", species_habitat_code)
   })
